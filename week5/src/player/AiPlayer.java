...
public class AiPlayer extends Player {
    ...
    /// 쉬움: 합법적인 수 중 랜덤으로 선택
    /// </summary>
    protected Move chooseEasy(ArrayList<Move> allMoves) {
    ...
    /// </summary>
    protected Move chooseNormal(SimpleBoard board, ArrayList<Move> allMoves) {
        // 상대 색상
    ...
    /// 임시로 이동했다가 되돌리는 방식
    /// </summary>
    protected boolean wouldCheckmate(SimpleBoard board, Move move, int opponentColor) {
        // 원래 상태 저장
    ...
    /// 임시로 이동했다가 되돌리는 방식
    /// </summary>
    protected boolean wouldCheck(SimpleBoard board, Move move, int opponentColor) {
        // 원래 상태 저장
        Piece movingPiece = board.grid[move.fromRow][move.fromCol].getPiece();
        Piece capturedPiece = board.grid[move.toRow][move.toCol].getPiece();
        int origRow = movingPiece.row;
