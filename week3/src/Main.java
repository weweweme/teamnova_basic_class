            ...
            switch (input) {
                ...
                case "3":
                    ...
                    while (true) {
                         ...
                         *    (216°)
                         */
                        // 5개 꼭짓점 좌표 (삼각함수 값 × 10000, 반올림 적용)
                        int S = 10000;
                        int H = S / 2;  // 반올림용 (5000)
                        int v0x = n;
                        int v0y = 0; // 0° (위)
                        int v1x = n + (n * 9511 + H) / S;  // 72° (오른쪽 위)
                        int v1y = n - (n * 3090 + H) / S;
                        int v2x = n + (n * 5878 + H) / S;  // 144° (오른쪽 아래)
                        int v2y = n + (n * 8090 + H) / S;
                        int v3x = n - (n * 5878 + H) / S;  // 216° (왼쪽 아래)
                        int v3y = n + (n * 8090 + H) / S;
                        int v4x = n - (n * 9511 + H) / S;  // 288° (왼쪽 위)
                        int v4y = n - (n * 3090 + H) / S;
