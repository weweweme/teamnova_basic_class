...
//
//   [★ 이 쿠키는 '기기 목록' 전용이다 — 목적을 하나로 줄였다]
//     예전엔 이 하나가 **조회수 중복 방지**도 겸했다. 편했지만 규정에 걸린다 —
//     *"쿠키가 여러 목적을 가지면 모든 목적이 면제여야 동의가 필요 없다"*(WP194).
//     기기 목록은 보안이라 면제지만 조회수 측정은 아니어서, **섞여 있으면 면제가 깨진다.**
//     → 조회수 판정은 **쿠키를 아예 안 쓰는 쪽**으로 옮겼다 — view_session.php 참고.
//       (접속지에서 번호를 계산해 별도 세션을 연다. 이 쿠키와는 이제 아무 관계가 없다)
// ============================================================
