...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            // 난이도 선택 입력 대기 (q로 게임 완전 종료)
            final int KEY_EASY = '1';
            final int KEY_NORMAL = '2';
            final int KEY_HARD = '3';
            final int KEY_QUIT = 'q';
            final int KEY_QUIT_UPPER = 'Q';

            Difficulty selectedDifficulty = null;
            boolean quit = false;
            while (selectedDifficulty == null && !quit) {
            ...
            stats.append("=== 게임 통계 ===\n");
            stats.append("생존 일수: " + dayNightCycle.getDay() + "일\n");
            stats.append("생존자: " + survivors + "/" + gameWorld.getColonists().size() + "명\n");
            stats.append("처치한 적: " + gameWorld.getEnemiesKilled() + "마리\n");
            ...
            stats.append("\n");
            stats.append("아무 키나 누르면 타이틀로 돌아갑니다...\n");
