...
public class TestAccountSeeder {
    ...
    public void seedIfMissing() {
        ...
        seedUser("tester3", "소울충", 0xFFE53935, "죽는 게 곧 재미",
                new int[]{1, 12, 3},
                new float[]{5.0f, 4.5f, 4.0f},
                new String[]{"소울 시리즈 최고봉 엘든 링", "다크 소울3 소울의 완성형", "할로우 나이트도 결국 소울류죠"});
        ...
        seedUser("tester5", "도트장인", 0xFF8E24AA, "픽셀 아트에 진심",
                new int[]{3, 16, 18},
                new float[]{5.0f, 4.5f, 5.0f},
                new String[]{"할로우 나이트 도트의 정점", "언더테일 두 번 하면 더 좋음", "오리 아트가 그림책 같아요"});
        ...
        seedUser("tester8", "오픈월드러", 0xFF6D4C41, "넓은 세계 탐험이 좋아",
                new int[]{2, 11, 10},
                new float[]{5.0f, 4.0f, 4.5f},
                new String[]{"발더스 게이트3 선택의 무게", "사이버펑크 이제 할 만해요", "위쳐3 방대한 세계"});
